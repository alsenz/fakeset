...
### Stage 1 — Models (~30 lines, zero test change)
...
### Stage 2 — Nested include rename + `_pool_idx` + `_slot_idx`
...
### Stage 5 — Top-level cardinality: plan
...
### Stage 6 — Top-level cardinality: execution
